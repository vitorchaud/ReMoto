...
public class ConfigurationDAO extends BasicDAO
{
	...
	public Configuration getConfiguration(int idConfiguration)
	{
        ...
        conf.setPrimaryBag1Gain(0);
        conf.setPrimaryBag2AndChainGain(0);
        conf.setSecondaryBag2AndChainGain(0);
    	...
    	conf.setFinalRecruitmentThresholdIa(30);
    	conf.setInitialRecruitmentThresholdII(0);
    	conf.setFinalRecruitmentThresholdII(30);
    	conf.setInitialRecruitmentThresholdIb(0);
    	conf.setFinalRecruitmentThresholdIb(30);
    ...
    private List loadMotorunitsTypes(int idConfiguration)
	{
    	...
    	try
    	{
        	...
        	while( rs.next() )
        	{
        		...
        		// Parâmetros para o MG, por enquanto utilizados para todos os músculos
        		/*
        		...
        		*/
        		if(mu.getCdNucleus().equals(ReMoto.SOL)){
                    if(mu.getType().equals("S")){
                        ...
                        mu.settwTet2(4.08);
                        mu.setbRaikova1(0.9);
                        mu.setbRaikova2(0.95);
                        mu.settwTetRaikova1(2.37);
                        mu.settwTetRaikova2(2.26);
                    }
                    else if(mu.getType().equals("FR")){
                        ...
                        mu.settwTet1(4.08);
                        mu.settwTet2(6.71);
                        mu.setbRaikova1(0.95);
                        mu.setbRaikova2(0.45);
                        mu.settwTetRaikova1(2.26);
                        mu.settwTetRaikova2(4.52);
                    }
                    else if(mu.getType().equals("FF")){
                        ...
                        mu.settwTet1(6.71);
                        mu.settwTet2(8.73);
                        mu.setbRaikova1(0.45);
                        mu.setbRaikova2(0.25);
                        mu.settwTetRaikova1(4.52);
                        mu.settwTetRaikova2(8.04);
                    }
                }
