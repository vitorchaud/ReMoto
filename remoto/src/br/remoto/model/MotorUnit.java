...
public class MotorUnit implements Serializable
{
	...
	*/
	...
	public double getTetanicForce() {
		
		double tetanicForce = 0;
		
		if(cdMuscleModel.equals("SOCDS") || cdMuscleModel.equals("hill")){
			tetanicForce = TwTet * Gpeak;
		}
		else if(cdMuscleModel.equals("raikova")){
			tetanicForce = TwTetRaikova * GpeakRaikova;
		}
