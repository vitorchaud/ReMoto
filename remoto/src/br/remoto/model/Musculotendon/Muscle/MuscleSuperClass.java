...
public abstract class MuscleSuperClass implements Serializable
{
	...
	//protected double lengthNormInitial;
	//protected double lengthNormAtEquilibrium;
	...
	protected void atualizeActivation(double t){
		...
		samplerMuscleActivationStore.sample(muscleActivationStore, "muscleActivation", t, activationNorm);
	}
