...
public class ResultDisplay
{
	...
	public void generateResults(Simulation sim, OutputStream stream)
    {
			...
			//System.out.println("numOfSubplots: " + numOfSubplots);
			//System.out.println("nmMuscles: " + nmMuscles[numOfSubplots - 1]);
			//System.out.println("nmCdNeurons: " + nmCdNeurons[numOfSubplots - 1]);
			//System.out.println("nmSubplots: " + nmSubplots[numOfSubplots - 1]);
			//System.out.println("nmCdSpecification: " + nmCdSpecification[numOfSubplots - 1]);
	...
	public void organizeNeurons(Simulation sim, String cdMuscle){
		...
		//if(numMNs != 0)	System.out.println("motoneurons: " + motoneurons.length);
		//if(numAFs != 0)	System.out.println("afferents: " + afferents.length);
	...
	private XYSeriesCollection processGraphic(OutputStream stream,
		...
		if(analysis && cdAnalysis.equals("parameters")){
			...
			if(isCV) 			serie7 = new XYSeries( "Coeficient of variation: " + Conversion.convertNumberOfDecimalAlgarisms(std/mean, 2));
