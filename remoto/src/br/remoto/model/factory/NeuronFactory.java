	...
	public Neuron create(List listNucleus, Configuration conf, Miscellaneous misc, NeuronVO reference, NeuronVO referenceS, NeuronVO referenceFR, NeuronVO referenceFF, int index)
	{
		...
		else if( reference.getCategory().equals( ReMoto.MN ) || reference.getCategory().equals( ReMoto.IN ) )
		{
			...
			if( reference.getCategory().equals( ReMoto.MN ) )
			{
				...
				System.out.println("dSoma: " + dSoma);
				System.out.println("lSoma: " + lSoma);
				System.out.println("dDend: " + dDend);
				System.out.println("lDend: " + lDend);
				System.out.println("rmSoma: " + rmSoma);
				System.out.println("rmDend: " + rmDend);
				System.out.println("ri: " + ri);
				System.out.println("cm: " + cm);
				
				System.out.println("areaSoma: " + areaSoma);
				System.out.println("areaDend: " + areaDend);
				
				System.out.println("gCoupling: " + gCoupling);
				System.out.println("gLeakSoma: " + gLeakSoma);
				System.out.println("gLeakDend: " + gLeakDend);
				...
				System.out.println("MN: " + neu.getCd() + " :  "+ pattern.getGCaPVO().getGmax() * 1e6 * areaDend);
