...
public class InibicaoReciproca 
{
	...
	public void levantaCurva()
	{
    	...
    	conf.getNeuronByType("TA", "Ia").setAxonVelocity1( 67 );
    	conf.getNeuronByType("TA", "Ia").setAxonVelocity2( 67 );
    	
    	conf.getNeuronByType("SOL", "Ia").setAxonVelocity1( 67 );
    	conf.getNeuronByType("SOL", "Ia").setAxonVelocity2( 67 );
